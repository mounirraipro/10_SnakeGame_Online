...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Snake Game Online puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Snake Game Online categories'],
  alternates: {
