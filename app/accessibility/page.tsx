...
export const metadata: Metadata = {
    ...
    description: 'Snake Game Online is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Snake Game Online accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Snake Game Online accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Snake Game Online is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Snake Game Online presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Snake Game Online. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@snakegame-online.com</strong></li>
                </ul>
                <p>
