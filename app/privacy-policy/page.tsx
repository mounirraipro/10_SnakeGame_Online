...
export const metadata: Metadata = {
    ...
    description: 'Read the Snake Game Online Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Snake Game Online privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Snake Game Online, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Snake Game Online, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Snake Game Online is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@snakegame-online.com</strong>.
                </p>
            </div>
        </>
    );
