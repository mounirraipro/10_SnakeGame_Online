...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Snake Game Online. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Snake Game Online sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Snake Game Online' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Snake Game Online?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Snake Game Online.</p>
                </div>
            </div>
