...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Snake Game Online uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Snake Game Online cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Snake Game Online uses them, and how you can
                ...
                <p>Snake Game Online uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Snake Game Online.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@snakegame-online.com</strong>.
                </p>
            </div>
        </>
    );
