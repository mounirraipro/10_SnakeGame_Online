...
export default function GameIframe({ src, title, className, style, scrolling }: GameIframeProps) {
  ...
  const handleShare = async () => {
    try {
      if (navigator.share) {
        await navigator.share({ title: 'Snake Game Online', text: 'Play this free puzzle game!', url: window.location.href });
      } else {
  ...
  return (
    ...
    >
      ...
      <div className="game-iframe-area">
        <iframe
          ref={iframeRef}
          src="https://html5.gamedistribution.com/5472c20853064b7b866a0d2629f2513d/?gd_sdk_referrer_url=https://www.snakegame-online.com/play"
          title={title}
        ...
        {!gameStarted && !inFull && (
          <div className="game-play-overlay" onClick={handleStartGame} role="button" aria-label="Click to play Snake Game Online">
            ...
            <div className="game-play-label">
              <strong>Play Snake Game Online</strong>
