...
const SUPPORT_EMAIL = 'hello@snakegame-online.com';

export const metadata: Metadata = {
    title: 'Contact Snake Game Online',
    description: 'Get in touch with the Snake Game Online team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Snake Game Online', 'Snake Game Online support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
