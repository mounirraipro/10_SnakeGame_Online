# AI Content Prompt - Snake Game Online
...
## GENRE CONTEXT - ARCADE

Use this knowledge to write accurate, specific content. Do NOT treat this as a generic game.

- **Core mechanics:** score-chasing, lives system, increasing speed/difficulty over time, leaderboards
- **Target audience:** nostalgic players and competitive gamers; all ages
- **Key player benefits:** high replayability, competitive via high scores, quick dopamine hits
- **Playstyle:** intense and repetitive in a good way; chasing personal bests
- **Level structure:** endless runner or wave-based; difficulty scales with time/score
- **SEO angles to use:** free arcade game online, classic arcade browser game, play arcade free
- **Tip writing style:** focus on survival first, learn safe zones, consistency beats reckless risk-taking
...
- Name five real difficulty tiers or game-mode categories that fit Arcade games.
...

{
  ...
  "homepage": {
    ...
    "about": {
      "kicker": "What is Snake Game Online?",
      "headline": "...",
      "paragraph1": "...",
      "paragraph2": "..."
    },
    ...
    "faq": [
      { "q": "What is Snake Game Online?",             "a": "..." },
      { "q": "Is Snake Game Online free?",             "a": "..." },
      { "q": "Does Snake Game Online work on mobile?", "a": "..." },
      { "q": "How many levels are there?",  "a": "..." },
      { "q": "Is Snake Game Online safe for kids?",    "a": "..." },
    ...
    "posts": [
      {
        ...
        "title": "Getting Started with Snake Game Online: A Complete Beginner's Guide",
        "excerpt": "...",
        "category": "Guide",
        "readTime": "5 min read",
        "date": "2026-01-01",
        "icon": "🗺️",
        "sections": [
          { "heading": "What Is Snake Game Online?",    "paragraphs": ["...", "..."] },
      ...
      },
      {
        ...
        "title": "Top Tips & Tricks for Snake Game Online",
        "excerpt": "...",
        "category": "Strategy",
        "readTime": "7 min read",
        "date": "2026-01-05",
      ...
      {
        "slug": "game-benefits",
        "title": "The Cognitive Benefits of Playing Snake Game Online",
        "excerpt": "...",
        "category": "Science",
        "readTime": "6 min read",
        "date": "2026-01-10",
      ...
      {
        "slug": "how-to-improve",
        "title": "How to Get Better at Snake Game Online",
        "excerpt": "...",
        "category": "Strategy",
        "readTime": "8 min read",
        "date": "2026-01-15",
      ...
      {
        "slug": "parents-guide",
        "title": "Snake Game Online for Kids: A Parent's Complete Guide",
        "excerpt": "...",
        "category": "Family",
        "readTime": "6 min read",
        "date": "2026-01-20",
        "icon": "👨‍👩‍👧",
        "sections": [
          { "heading": "Is Snake Game Online Safe for Children?", "paragraphs": ["...", "..."] },
